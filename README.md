...
## Development environment and release process
 ...
 - create virtualenv with Flask and test_dublinBikes installed into it (latter is installed in
...
install it (`pip install test_dublinBikes.tar.gz`), ensure that configuration file exists and
`TEST_DUBLINBIKES_SETTINGS` environment variable points to it, ensure that user has access to the
